...
| **Current Step** | P85 FROZEN：零額外付費 R-016 修復總計畫已凍結；下一步等主公核准 P86 才能改程式碼 |
| **Mode** | FROZEN |
...
| L3 | `docs/PHASE_85_PLAN.md` | P85-P95 零額外付費修復總計畫 |
...
| **Resume Rule** | 新視窗讀本區塊與 `docs/PHASE_85_PLAN.md`；若主公說「開始」，先確認是核准 P86，再依 P86 scope 動工 |
