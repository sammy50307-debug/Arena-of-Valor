...
| L3 | `docs/PHASE_88_PLAN.md` | P88 Deterministic Local Analyzer 凍結計畫 |
...
| **Resume Rule** | 新視窗讀本區塊與 `docs/PHASE_88_PLAN.md`；若主公說「核准 P88」或「開始 P88 runtime」，才可依計畫動工，否則只能討論或推已凍結 commit |
...
- 不要直接改 runtime code；P88 目前是 FROZEN，需主公核准才能動工。
