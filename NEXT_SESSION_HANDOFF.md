...
| **Resume Rule** | 新視窗讀本區塊、`docs/PHASE_96_PLAN.md`、`docs/PHASE_96_EVIDENCE_INVENTORY.md`；若本地有 second guard changes，先完成 tests/commit；若已 pushed，下一步是重新產生報告或手動 dispatch verification |
