...
3. 讀 `docs/PHASE_84_PLAN.md` 的 P84.4 範圍；P84.3 已完成，下一步等主公指示是否進 Risk registry / runbook governance
...
| L4 | `docs/PHASE_84_PLAN.md` | 當前 Phase 已核准計畫，下一步 P84.4 |
...
| **Resume Rule** | 新視窗只用本區塊決定下一步；P84.3 已完成，等主公指示後再進 P84.4，不可跨步到 P84.5+ |
