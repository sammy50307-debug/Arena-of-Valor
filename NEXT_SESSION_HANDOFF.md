...
2. `docs/PHASE_85_PLAN.md` 的 P88 roadmap
...
| L3 | `docs/PHASE_85_PLAN.md` 的 P86-P95 roadmap | P88 下一步來源；`docs/PHASE_88_PLAN.md` 尚待建立 |
...
| **Resume Rule** | 新視窗讀本區塊與 `docs/PHASE_85_PLAN.md` P88 row；若主公說「凍結 P88」或「開始規劃 P88」，只建立/更新 `docs/PHASE_88_PLAN.md`，不得改 runtime code |
...
- 不要把 P87 CLOSED 解讀成 R-016 CLOSED；R-016 仍 Open，後續要走 P88-P95。
...
- 不要把 R-016 標記 Closed；P87 是 core contract 地基，不是 R-016 closeout。
- 不要直接改 runtime code；P88 目前只能先建立/凍結 plan。
