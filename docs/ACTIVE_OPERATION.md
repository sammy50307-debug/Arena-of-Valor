...
| **Resume Rule** | 新視窗先讀 `NEXT_SESSION_HANDOFF.md` 頂部 active bootstrap；P84.2 已完成，等主公指示後再進 P84.3，不可跨步到 P84.4+ |
...
P84.2 SLO / escalation checker 已完成。下一步是 P84.3 Handoff truth checker；等主公指示後再動工，push 前仍需主公確認。
