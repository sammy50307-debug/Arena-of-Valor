...
| **Resume Rule** | 新視窗先讀 `NEXT_SESSION_HANDOFF.md` 頂部 active bootstrap 與 `docs/PHASE_94_PLAN.md`；若本地 ahead 1，先等主公 push；push 完成後才開 P95 closeout verification plan |
