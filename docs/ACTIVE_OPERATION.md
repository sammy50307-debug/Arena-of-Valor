...
| **Resume Rule** | 新視窗先讀 `NEXT_SESSION_HANDOFF.md` 頂部 active bootstrap 與 `docs/PHASE_95_PLAN.md` §14；若本地 ahead 1，先等主公 push；R-016 仍 Open，下一步是 post-P94 Daily Monitor 補證 |
