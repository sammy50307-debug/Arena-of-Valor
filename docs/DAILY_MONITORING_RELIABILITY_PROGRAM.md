...
| **P84** | Long-Term Governance | retention、SLO、handoff truth、risk registry、runbook | FROZEN（2026-05-17：PHASE_84_PLAN 已凍結，等待主公核准） |
...
- 狀態：FROZEN（2026-05-17：`docs/PHASE_84_PLAN.md` 已凍結，等待主公核准；不可直接改程式碼）
- retention policy
