...
| **P84** | Long-Term Governance | retention、SLO、handoff truth、risk registry、runbook | APPROVED（2026-05-17：P84.1 retention dry-run 已完成，下一步 P84.2 SLO） |
...
- 狀態：APPROVED（2026-05-17：P84.1 retention policy / dry-run inventory 已完成；下一步 P84.2 SLO / escalation checker）
- retention policy
