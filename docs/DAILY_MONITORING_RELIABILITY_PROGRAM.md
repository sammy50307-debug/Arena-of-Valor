...
| **P84** | Long-Term Governance | retention、SLO、handoff truth、risk registry、runbook | APPROVED（2026-05-17：主公核准，下一步 P84.1 retention dry-run） |
...
- 狀態：APPROVED（2026-05-17：主公核准；下一步 P84.1 retention policy / dry-run inventory）
- retention policy
