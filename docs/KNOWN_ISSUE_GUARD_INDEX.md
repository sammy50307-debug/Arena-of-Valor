...
| R-023 | Monitoring review false closure / missing guard prioritization drift | `docs/PHASE_102_PLAN.md`; `docs/RISK_REGISTRY.md` R-023; `docs/KNOWN_ISSUE_GUARD_INDEX.md` | N/A | N/A | Open Plan only | missing-machine-guard; human-only; plan-only | Freeze P102 plan before any runtime review, closeout, or guard implementation. |
